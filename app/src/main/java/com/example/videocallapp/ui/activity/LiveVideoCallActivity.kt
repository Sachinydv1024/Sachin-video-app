...
import com.example.videocallapp.databinding.ActivityLiveVideoCallBinding
...
class LiveVideoCallActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityLiveVideoCallBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityLiveVideoCallBinding.inflate(layoutInflater)
